...
FIG_DIR = PROJECT_ROOT / "figures" / "20260210_SAC_Return_FineTune_Actor_Only"
FIG_DIR.mkdir(parents=True, exist_ok=True)
LOG_DIR = PROJECT_ROOT / "runs" / "20260210_SAC_Return_FineTune_Actor_Only"
...
def train(args) -> None:
    ...
    if getattr(args, "init_from", None):
        ...
        # Alpha: reset to 0 (alpha=1.0) for maximum exploration in the new env
        with torch.no_grad():
            log_alpha.fill_(0.0)
