...
SCRIPT_TAG = "20260311_PPO_SAM_Scratch"
...
def train(args) -> None:
    ...
    print("[Init] Training from scratch (No Transfer Learning).")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--freeze_actor_episodes", type=int, default=0,
                        help="Should be 0 for scratch training.")
